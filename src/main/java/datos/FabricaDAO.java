...
public class FabricaDAO {
    ...
    private static final String SQL_SELECT_PRECIO_COSTO = "SELECT * FROM Precio WHERE nombre_pieza = ?";
    ...
    public List<Pieza> listaPrecioCosto(String nombrePieza) {
        ...
        try {
            ...
            stmt = conn.prepareStatement(SQL_SELECT_PRECIO_COSTO);
